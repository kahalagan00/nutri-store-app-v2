...
export const SIGN_UP_BOX_STYLE: string =
  " w-[50rem] m-6 p-6 rounded-xl bg-login-gradient drop-shadow-lg font-lato";
export const LOG_IN_BOX_STYLE: string =
  "flex h-[36rem] w-[30rem] flex-col justify-start rounded-xl bg-login-gradient px-12 py-10 drop-shadow-lg";
export const SIGN_UP_SCREEN_BACKGROUND_STYLE: string =
  "absolute inset-0 flex h-screen w-screen items-start justify-center";
