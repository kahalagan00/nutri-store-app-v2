...
export const CapsuleForward: React.FC = () => {
  return (
    <div className="grid h-[30px] w-[100px] grid-cols-[1fr_20px] items-center rounded-full bg-blue-600 px-1 md:h-[50px] md:w-[150px] md:px-4">
